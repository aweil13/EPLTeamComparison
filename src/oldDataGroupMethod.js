...
.attr("transform", "translate(" + margin.left + "," + margin.top + ")");
  ...
  svg.append("text").attr("x", 120).attr("y", 50).style("fill", "white").text("Liverpool 2012-13").attr("alignment-baseline","middle")
  svg.append("text").attr("x", 120).attr("y", 70).style("fill", "white").text("Aston Villa 2009-10").attr("alignment-baseline","middle")
